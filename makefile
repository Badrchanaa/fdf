...
SOURCES = color.c main.c init.c common_utils.c parser.c parse_utils.c draw_utils.c translate.c rot_utils.c transform_utils.c event_handlers.c cleanup.c bline.c line_draw_utils.c
OBJECTS = $(SOURCES:.c=.o)
